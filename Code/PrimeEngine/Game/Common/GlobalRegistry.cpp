		...
		// start root.PE
		{
			...
			// start root.PE.Components
			{
				PE::Components::Component::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::UIManager::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::SceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						...
						PE::Components::UIElement::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						PE::Components::UIButton::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						PE::Components::ButtonSceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						PE::Components::LineSceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::ButtonMesh::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Components::SoundComponent::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.PE.Events
			{
				PE::Events::Event::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_CREATE_BUTTON::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_PAUSE_GAME::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_DEBUG_TEXT::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_RESUEME_GAME::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					// Standard keyboard events
					PE::Events::Event_LEFT_CLICK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
