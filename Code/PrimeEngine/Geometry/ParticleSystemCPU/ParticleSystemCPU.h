...
#include <PrimeEngine/Scene/ParticleMesh.h>
...
namespace PE {
	...
	struct ParticleSystemCPU : PE::PEAllocatableAndDefragmentable
	{
		...
		ParticleSystemCPU(PE::GameContext& context, PE::MemoryArena arena, PE::Components::Particle& particle) 
		{
			m_arena = arena; m_pContext = &context; m_particleTemplate = particle;
		}
		...
		Matrix4x4 m_base;
		PE::Components::Particle m_particleTemplate;
		PrimitiveTypes::Float32 m_pastTime;

		PE::Components::ParticleMesh::ParticleSystemType m_systemType;
