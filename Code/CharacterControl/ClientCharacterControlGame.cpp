...
// 			}
	...
	m_pContext->getLuaEnvironment()->runString("LevelLoader.loadLevel('animationhw.x_level.levela', 'ExportTutorial')");
	//m_pContext->getLuaEnvironment()->runString("LevelLoader.loadLevel('waypointtutorial.x_level.levela', 'CharacterControl')");
	// m_pContext->getLuaEnvironment()->runString("LevelLoader.loadLevel('task2.x_level.levela', 'CharacterControl')");
	 //m_pContext->getLuaEnvironment()->runString("LevelLoader.loadLevel('ccontrollvl0.x_level.levela', 'CharacterControl')");
	m_pContext->getGPUScreen()->AcquireRenderContextOwnership(m_pContext->m_gameThreadThreadOwnershipMask);
